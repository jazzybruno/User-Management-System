...
<body>
   ...
   <div class=" mt-16 ml-96">
       <div class="flex ">
       <a href="./index.php" class=" p-4 rounded-md bg-green-300 shadow-md mt-7  decoration-none hover:bg-white ">All Product</a>
       </div>
    ...
    $connect = mysqli_connect($DB_server,$DB_user_name,$DB_user_password,$DB_name);
       ...
       if ($connect) {
        ...
        $name = $_POST['search'];
       $query = mysqli_query($connect, "SELECT * FROM products WHERE prod_name = '$name'") or die("Error".mysqli_error());?>
